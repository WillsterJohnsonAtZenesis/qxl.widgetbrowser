...
qx.Class.define("qxl.widgetbrowser.view.TabView", {
  ...
  members: {
    init() {
      ...
      var tree = new qxl.widgetbrowser.view.TabPage(
        "Tree",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var list = new qxl.widgetbrowser.view.TabPage(
        "List",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var table = new qxl.widgetbrowser.view.TabPage(
        "Table",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var win = new qxl.widgetbrowser.view.TabPage(
        "Window",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var control = new qxl.widgetbrowser.view.TabPage(
        "Control",
        classname,
        controls
      );
      ...
      controls = {};
      var embed = new qxl.widgetbrowser.view.TabPage(
        "Embed",
        classname,
        controls
      );
      ...
      controls = {};
      var embedFrame = new qxl.widgetbrowser.view.TabPage(
        "EmbedFrame",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var basic = new qxl.widgetbrowser.view.TabPage(
        "Basic",
        classname,
        controls
      );
      ...
      controls = { disabled: true };
      var misc = new qxl.widgetbrowser.view.TabPage(
        "Misc",
        classname,
        controls
      );
